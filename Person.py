...
class Person:
    ...
    def did_survive_infection(self):
        ...
        mortality_chance = random.uniform(0.0, 1.0)
        # print (mortality_chance) # not printing :(
        print(mortality_chance)
        print(self.infection.mortality_num)
        if mortality_chance < self.infection.mortality_num:
            # self.is_alive = False
            return False
        else:

...
class Simulation:
    ...
    def print_population(self):
        ...
        # print (f"Death Count: {self.total_dead}")
        # print (f"# of Vaccinated: {self.total_vaccinated}")
    ...
    def simulation_should_continue(self):
        ...
        print("Total Infected", len(self.get_infected()))
        print("Total Vax", self.total_vaccinated)
        if self.total_dead == len(self.population):
            return False
        elif self.total_vaccinated == len(self.population):
            return False
        elif self.total_dead + self.total_vaccinated == len(self.population):
            return False
